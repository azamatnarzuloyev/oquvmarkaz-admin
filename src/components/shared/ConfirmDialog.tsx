...
interface ConfirmDialogProps extends DialogProps {
    ...
    onCancel?: (e: MouseEvent<HTMLSpanElement>) => void
    onConfirm?: (e: MouseEvent<HTMLSpanElement>) => void
    onRequestClose?: (e: MouseEvent<HTMLSpanElement>) => void
}
...
const ConfirmDialog = (props: ConfirmDialogProps) => {
    ...
    const handleConfirm = (e: MouseEvent<HTMLSpanElement>) => {
        onConfirm?.(e)
    }

    return (
        <Dialog contentClassName="pb-0 px-0" onRequestClose={(e: MouseEvent<HTMLSpanElement>)=> onRequestClose?.(e)}  {...rest} >
