...
export const MERGE_FIELDS_DEFINITIONS = [
    {
...
export const MERGE_FIELDS_DATASETS = [
    {
        id: '78900',
        label: 'David Lee',
        values: {
...
//     'eyJhbGciOiJFUzI1NiJ9..BANSm2U67Hu_ElVhlWKt0Brqq0b90hapQ_I0uUriYnVZLdQSdQ7ppwxegqi1PKEGUtIJAZkyco2W9oyQFURnyg'

export const LICENSE_KEY: string = 'GPL'

export const WEB_SPELL_CHECKER_LICENSE_KEY = ''

export const CKBOX_TOKEN_URL = ''
...
export function customMentionUserItemRenderer(item: any) {
